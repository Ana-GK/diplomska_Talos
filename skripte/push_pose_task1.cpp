...
int main(int argc, char** argv)
{
  ...
  nh.param<std::string>("link_name", link_name, "gripper_right_base_link");
  ...
  nh.param<std::string>("respect_task_id", previous_task_id, "gripper_left_base_link_reference_pose");
  ...
  nh.param<std::string>("topic_name", topic_name, ns+"/gripper_right");
  ...
  pal_wbc_msgs::Order::_order_type order = pal_wbc_msgs::Order::Same;
