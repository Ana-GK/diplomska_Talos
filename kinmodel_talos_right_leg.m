function [p,R,J]=kinmodel_talos_right_leg(q,tcp)
% KINMODEL_TALOS_RIGHT_LEG Kinematic model for TALOS (generated from /home/cobotat4/robotblockset/robot_models/talos.urdf)
% 
% Usage: 
%           [p,R,J]=kinmodel_talos_right_leg(q,tcp)
%           [p,R,J]=kinmodel_talos_right_leg(q)
% 
% Input: 
