function [p,R,J]=kinmodel_talos_left_arm(q,tcp)
% KINMODEL_TALOS_LEFT_ARM Kinematic model for TALOS (generated from /home/cobotat4/robotblockset/robot_models/talos.urdf)
% 
% Usage: 
%           [p,R,J]=kinmodel_talos_left_arm(q,tcp)
%           [p,R,J]=kinmodel_talos_left_arm(q)
% 
% Input: 
